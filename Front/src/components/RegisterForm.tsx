...
export const RegisterForm = () => {
    ...
    return (
        ...
        <form className=" md:space-y-1" action="#" onSubmit={handleSubmit}>
            ...
            <button type="submit" className="w-full text-white bg-amber-500 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 rounded-2xl text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 font-bold">REGISTRARME</button>
