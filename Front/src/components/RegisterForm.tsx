...
//             </div>
//             {/* <div>
//                 <label htmlFor="dni" className="block mb-2 text-sm text-left font-medium text-gray-900 dark:text-white">Dni</label>
//                 <input type="number" name="dni" id="dni" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Dni" onChange={(e) => setDni(Number.parseInt(e.target.value))} />
//             </div> */}
...
//             <div>
//                 {data.map(item => (
//                     <div className="flex items-center space-x-5" key={item._id} onChange={handleChange}>
//                         <input id="default-radio-1" type="radio" value={item._id} name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
//                         <label htmlFor="default-radio-1" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">{item.name}</label>
//                     </div>
//                 ))}
//             </div>
