...
const SideBar: React.FC<SideBarProps> = ({ handleLinkClick }) => {
  ...
  return (
    <>
      <div className="md:hidden mt-[4.6rem] bg-[#90A4AE] mx-6 rounded-xl fixed top-0 left-0 right-0 z-10">
      ...
      <aside className="hidden md:block ml-[-100%] lg:mt-[4.2rem] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-[#90A4AE] transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
        <div>
